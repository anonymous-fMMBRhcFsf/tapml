...
from tapml.interface.gen_config import CONV_TEMPLATES, gen_config
...
from tapml.support.auto_config import detect_config, detect_model_type


def main(argv):
    """Parse command line argumennts and call `tapml.compiler.gen_config`."""
    parser = ArgumentParser("TapML Configuration Generator")
    ...
    parser.add_argument(
        ...
        type=_parse_output,
        required=True,
        help=HELP["output_gen_tapml_chat_config"] + " (required)",
    )
