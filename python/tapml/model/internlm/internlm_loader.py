"""
This file specifies how TapML's InternLM parameter maps from other formats, for example HuggingFace
...
def huggingface(model_config: InternLMConfig, quantization: Quantization) -> ExternMapping:
    ...
    for i in range(model_config.num_hidden_layers):
        ...
        tapml_name = f"{attn}.wqkv_pack.weight"
        ...
        tapml_name = f"{attn}.wqkv_pack.bias"
