...
from tapml.loader import LOADER
from tapml.model import Model
from tapml.quantization import Quantization
from tapml.support import logging, tqdm
from tapml.support.preshard import apply_preshard
from tapml.support.style import bold, green
...
class ConversionArgs:  # pylint: disable=too-many-instance-attributes
    """Arguments to TapML's weight conversation and quantization flow."""
...
def _convert_args(args: ConversionArgs) -> None:  # pylint: disable=too-many-locals
    pre_shards_num = os.getenv("TAPML_INTERNAL_PRESHARD_NUM")
...
def convert_weight(  # pylint: disable=too-many-arguments
    ...
    """TapML's weight conversation and quantization flow."""
