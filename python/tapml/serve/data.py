"""Classes denoting multi-modality data used in TapML serving"""
...
@tvm._ffi.register_object("tapml.serve.Data")  # pylint: disable=protected-access
class Data(Object):
...
@tvm._ffi.register_object("tapml.serve.TextData")  # pylint: disable=protected-access
class TextData(Data):
...
@tvm._ffi.register_object("tapml.serve.TokenData")  # type: ignore  # pylint: disable=protected-access
...
@tvm._ffi.register_object("tapml.serve.ImageData")  # type: ignore  # pylint: disable=protected-access
...
@tvm._ffi.register_object("tapml.serve.RequestStreamOutput")  # pylint: disable=protected-access
