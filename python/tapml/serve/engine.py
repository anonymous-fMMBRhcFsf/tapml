...
class ModelInfo:
    ...
    model : str
        ...
        (e.g., "dist/prebuilt/tapml-chat-Llama-2-7b-chat-hf-q4f16_1")
...
def _estimate_max_total_sequence_length(  # pylint: disable=too-many-locals
    ...
    gpu_size_bytes = os.environ.get("TAPML_GPU_SIZE_BYTES", default=None)
    if gpu_size_bytes is None:
        ...
        if gpu_size_bytes is None:
            raise ValueError(
                ...
                'Please the GPU memory size in bytes through "TAPML_GPU_SIZE_BYTES" env variable.'
            )
...
class Engine:
    """The Python interface of request serving engine for TapML.
    ...
    def __init__(  # pylint: disable=too-many-arguments
        ...
        # Todo(tapml-team): use `max_single_sequence_length` only after impl input chunking.
