...
import ai.tapml.tapml.ChatModule
...
class AppViewModel(application: Application) : AndroidViewModel(application) {
    ...
    companion object {
        ...
        const val ModelConfigFilename = "tapml-chat-config.json"
    ...
    fun copyError() {
        ...
        clipboard.setPrimaryClip(ClipData.newPlainText("TapmlChat", errorMessage()))
    }
