...
TVM_REGISTER_GLOBAL("tapml.TextStreamer").set_body_typed([](Tokenizer tokenizer) {
  return TextStreamer(std::move(tokenizer));
});

TVM_REGISTER_GLOBAL("tapml.TextStreamerPut")
...
TVM_REGISTER_GLOBAL("tapml.TextStreamerFinish")
...
TVM_REGISTER_GLOBAL("tapml.StopStrHandler")
...
TVM_REGISTER_GLOBAL("tapml.StopStrHandlerPut")
...
TVM_REGISTER_GLOBAL("tapml.StopStringHandlerFinish").set_body_typed([](StopStrHandler handler) {
  std::vector<int32_t> remaining_token_ids = handler->Finish();
  return IntTuple(remaining_token_ids.begin(), remaining_token_ids.end());
});

TVM_REGISTER_GLOBAL("tapml.StopStrHandlerStopTriggered")
