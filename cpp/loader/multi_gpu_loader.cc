...
TVM_REGISTER_GLOBAL("tapml.loader.LoadMultiGPU").set_body_typed(LoadMultiGPU);
TVM_REGISTER_GLOBAL("tapml.loader.LoadMultiGPUPresharded").set_body_typed(LoadMultiGPUPresharded);
