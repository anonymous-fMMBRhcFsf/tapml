 ...
 */
#ifndef TapML_SERVE_ENGINE_STATE_H_
#define TapML_SERVE_ENGINE_STATE_H_
...
class EngineStateObj : public Object {
 public:
  ...
  static constexpr const char* _type_key = "tapml.serve.EngineState";
...
#endif  // TapML_SERVE_ENGINE_STATE_H_
