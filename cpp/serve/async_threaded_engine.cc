 ...
 * \brief The implementation for asynchronous threaded serving engine in TapML.
 */
...
class AsyncThreadedEngineImpl : public AsyncThreadedEngine, public ModuleNode {
 public:
  TVM_MODULE_VTABLE_BEGIN("tapml.serve.async_threaded_engine");
...
TVM_REGISTER_GLOBAL("tapml.serve.create_threaded_engine").set_body_typed([]() {
