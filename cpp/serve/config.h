 ...
 * \file serve/config.h
 */
#ifndef TapML_SERVE_CONFIG_H_
#define TapML_SERVE_CONFIG_H_
...
class GenerationConfigNode : public Object {
 public:
  ...
  static constexpr const char* _type_key = "tapml.serve.GenerationConfig";
...
class KVCacheConfigNode : public Object {
 public:
  ...
  static constexpr const char* _type_key = "tapml.serve.KVCacheConfig";
  static constexpr const bool _type_has_method_sequal_reduce = false;
  static constexpr const bool _type_has_method_shash_reduce = false;
...
class EngineModeNode : public Object {
 public:
  ...
  static constexpr const char* _type_key = "tapml.serve.EngineMode";
  static constexpr const bool _type_has_method_sequal_reduce = false;
  static constexpr const bool _type_has_method_shash_reduce = false;
