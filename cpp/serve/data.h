 ...
 * \file serve/data.h
 */
#ifndef TapML_SERVE_DATA_H_
#define TapML_SERVE_DATA_H_
...
class DataNode : public Object {
 public:
  ...
  static constexpr const char* _type_key = "tapml.serve.Data";
...
class TextDataNode : public DataNode {
 public:
  ...
  static constexpr const char* _type_key = "tapml.serve.TextData";
...
class TokenDataNode : public DataNode {
 public:
  ...
  static constexpr const char* _type_key = "tapml.serve.TokenData";
...
class ImageDataNode : public DataNode {
 public:
  ...
  static constexpr const char* _type_key = "tapml.serve.ImageData";
...
class RequestStreamOutputObj : public Object {
 public:
  ...
  static constexpr const char* _type_key = "tapml.serve.RequestStreamOutput";
  static constexpr const bool _type_has_method_sequal_reduce = false;
  static constexpr const bool _type_has_method_shash_reduce = false;
