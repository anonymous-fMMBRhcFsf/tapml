...
#ifndef TapML_SERVE_GRAMMAR_GRAMMAR_H_
#define TapML_SERVE_GRAMMAR_GRAMMAR_H_
...
class BNFGrammarNode : public Object {
 public:
  ...
  static constexpr const char* _type_key = "tapml.serve.BNFGrammar";
...
#endif  // TapML_SERVE_GRAMMAR_GRAMMAR_H_
