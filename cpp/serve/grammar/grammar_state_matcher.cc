...
TVM_REGISTER_GLOBAL("tapml.serve.GrammarStateMatcherFromTokenizer")
...
TVM_REGISTER_GLOBAL("tapml.serve.GrammarStateMatcherFromTokenTable")
...
TVM_REGISTER_GLOBAL("tapml.serve.GrammarStateMatcherDebugAcceptCodepoint")
...
TVM_REGISTER_GLOBAL("tapml.serve.GrammarStateMatcherDebugMatchCompleteString")
...
void PrintAcceptedRejectedTokens(
    const std::shared_ptr<tapml::llm::serve::GrammarStateInitContext>& init_ctx,
...
TVM_REGISTER_GLOBAL("tapml.serve.GrammarStateMatcherFindNextRejectedTokens")
