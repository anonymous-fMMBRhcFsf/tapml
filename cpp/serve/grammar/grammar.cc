...
TVM_REGISTER_GLOBAL("tapml.serve.BNFGrammarFromEBNFString")
...
TVM_REGISTER_GLOBAL("tapml.serve.BNFGrammarFromJSON").set_body_typed([](String json_string) {
...
BNFGrammar BNFGrammar::FromSchema(const String& schema, int indent,
  ...
  static const PackedFunc* json_schema_to_ebnf = Registry::Get("tapml.serve.json_schema_to_ebnf");
  CHECK(json_schema_to_ebnf != nullptr) << "tapml.serve.json_schema_to_ebnf is not registered.";
...
TVM_REGISTER_GLOBAL("tapml.serve.BNFGrammarFromSchema")
...
TVM_REGISTER_GLOBAL("tapml.serve.BNFGrammarGetGrammarOfJSON").set_body_typed([]() {
