...
#ifndef TapML_SERVE_GRAMMAR_GRAMMAR_STATE_MATCHER_H_
#define TapML_SERVE_GRAMMAR_GRAMMAR_STATE_MATCHER_H_
...
class GrammarStateMatcherNode : public Object {
 public:
  ...
  static constexpr const char* _type_key = "tapml.serve.GrammarStateMatcher";
...
class GrammarInitContextStorageNode : public Object {
 public:
  ...
  static constexpr const char* _type_key = "tapml.serve.GrammarInitContextStorageNode";
  static constexpr const bool _type_has_method_sequal_reduce = false;
  static constexpr const bool _type_has_method_shash_reduce = false;
...
#endif  // TapML_SERVE_GRAMMAR_GRAMMAR_STATE_MATCHER_H_
