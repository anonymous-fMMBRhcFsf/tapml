 ...
 */
#ifndef TapML_SERVE_GRAMMAR_GRAMMAR_STATE_MATCHER_BASE_H_
#define TapML_SERVE_GRAMMAR_GRAMMAR_STATE_MATCHER_BASE_H_
...
#endif  // TapML_SERVE_GRAMMAR_GRAMMAR_STATE_MATCHER_BASE_H_
