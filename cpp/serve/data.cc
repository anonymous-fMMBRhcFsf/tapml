...
TVM_REGISTER_GLOBAL("tapml.serve.TextData").set_body_typed([](String text) {
  return TextData(std::move(text));
});

TVM_REGISTER_GLOBAL("tapml.serve.TextDataGetTextString").set_body_typed([](TextData data) {
  return data->text;
});
...
TVM_REGISTER_GLOBAL("tapml.serve.TokenData").set_body([](TVMArgs args, TVMRetValue* rv) {
...
TVM_REGISTER_GLOBAL("tapml.serve.TokenDataGetTokenIds").set_body_typed([](TokenData data) {
...
TVM_REGISTER_GLOBAL("tapml.serve.ImageData").set_body_typed([](NDArray image, int embed_size) {
  return ImageData(std::move(image), embed_size);
});

TVM_REGISTER_GLOBAL("tapml.serve.ImageDataGetImage").set_body_typed([](ImageData data) {
  return data->image;
});
...
TVM_REGISTER_GLOBAL("tapml.serve.RequestStreamOutputUnpack")
