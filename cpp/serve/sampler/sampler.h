...
#ifndef TapML_SERVE_SAMPLER_SAMPLER_H_
#define TapML_SERVE_SAMPLER_SAMPLER_H_
...
class SamplerObj : public Object {
 public:
  ...
  static constexpr const char* _type_key = "tapml.serve.Sampler";
...
#endif  // TapML_SERVE_SAMPLER_SAMPLER_H_
